...
InternetLink='https://github.com/loosolab/TOBIAS.git'
NameUncompress="TOBIAS"
TestCmd="./TOBIAS ATACorrect --help"
#PackageVers=""

CheckPythonModules 'numpy' 'scipy' 'pysam' 'pybedtools' 'matplotlib' 'scikit-learn' 'pandas' 'pypdf2' 'xlsxwriter' 'adjustText' 'pyBigWig' 'MOODS-python' 'svist4get' 'gimmemotifs' 'logomaker' 'seaborn' 'boto3' 'pyyaml' 'kneed'

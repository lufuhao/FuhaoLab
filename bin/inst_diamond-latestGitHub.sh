...
cd ${PROGPATH}/$PackageName/$NameUncompress
DeleteCreatePath ${PROGPATH}/$PackageName/$NameUncompress/bin
cd ${PROGPATH}/$PackageName/$NameUncompress/bin
RunCmds "cmake -DCMAKE_INSTALL_PREFIX=${PROGPATH}/$PackageName/$PackageVers/$MACHTYPE -DCMAKE_BUILD_MARCH=native .."

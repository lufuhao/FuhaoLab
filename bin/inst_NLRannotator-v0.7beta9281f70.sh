...
DownloadWget https://github.com/steuernb/NLR-Annotator/releases/download/v0.7-beta/NLR-Annotator.jar NLR-Annotator.jar
DownloadWget https://github.com/steuernb/NLR-Annotator/releases/download/v0.7-beta/NLR-Parser.jar NLR-Parser.jar

...
InternetLink='https://github.com/SunPengChuan/wgdi.git'
NameUncompress="wgdi"
TestCmd="./wgdi --help"
#PackageVers="v0.4.5-53914c3"

CheckPythonModules 'pandas' 'numpy' 'biopython' 'matplotlib' 'scipy'
...
PackageVers="v"$(grep 'version' setup.py | sed "s/^.*version=\"//; s/\".*$//;")"-"$(git branch -vv | cut -f 3 -d' ')
PrintInfo "Version: $PackageVers"

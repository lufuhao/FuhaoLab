...
InternetLink='https://github.com/chrchang/plink-ng.git'
NameUncompress="plink-ng"
TestCmd="./plink2 --help"
#PackageVers=""
...
cd ${PROGPATH}/$PackageName/$NameUncompress/2.0
RunCmds "./build.sh"
DeletePath ${PROGPATH}/$PackageName/$PackageVers/$MACHTYPE
RunCmds "make DESTDIR=\"\" PREFIX=${PROGPATH}/$PackageName/$PackageVers/$MACHTYPE install"

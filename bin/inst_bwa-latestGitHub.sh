...
#cd ${PROGPATH}/$PackageName/$NameUncompress
RunCmds "make"
RunCmds "mkdir -p bin include lib man/man1"
RunCmds "mv bwa qualfa2fq.pl xa2multi.pl bin/"
RunCmds "mv *.h include/"
RunCmds "mv libbwa.a lib/"
RunCmds "mv bwa.1 man/man1/"
#RunCmds "rm *.md Makefile COPYING ChangeLog bwa-helper.js"

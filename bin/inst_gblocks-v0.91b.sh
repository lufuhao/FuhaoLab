...
PackageName="gblocks"
PackageVers="v0.91b"
InternetLink="http://molevol.cmima.csic.es/castresana/Gblocks/Gblocks_Linux64_0.91b.tar.Z"
NameUncompress="Gblocks_0.91b"
TestCmd="./Gblocks --help"
...
#$TestCmd
if [ ! -x ${PROGPATH}/$PackageName/$PackageVers/$MACHTYPE/Gblocks ]; then

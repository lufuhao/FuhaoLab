...
PackageName="root"
PackageVers="v6.24.00"
InternetLink="https://root.cern/download/root_v6.24.00.Linux-ubuntu20-x86_64-gcc9.3.tar.gz"
NameUncompress="root"


NameCompress="$PackageName-$PackageVers.Linux-x86_64.tar.gz"

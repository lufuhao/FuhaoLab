...
PackageName="bioconvert"
TestCmd="./bioconvert --help"

CheckPythonModules 'easydev' 'colorlog' 'pandas' 'biopython' 'mappy' 'matplotlib' 'networkx' 'pyyaml' 'pysam' 'pyexcel' 'pyexcel-ods3' 'xlrd' 'pyBigWig' 'py2bit'

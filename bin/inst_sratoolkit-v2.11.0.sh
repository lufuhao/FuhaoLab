...
PackageName="sratoolkit"
PackageVers="v2.11.0"
InternetLink="https://ftp-trace.ncbi.nlm.nih.gov/sra/sdk/2.11.0/sratoolkit.2.11.0-ubuntu64.tar.gz"
PrintInfo "For Ubuntu x64 only"
NameUncompress="sratoolkit.2.11.0-ubuntu64"
TestCmd="./prefetch --help"

NameCompress=$PackageName-$PackageVers.ubuntu64.tar.gz
